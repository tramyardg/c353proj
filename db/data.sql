INSERT INTO bookstore353.authors (first_name, middle_name, last_name, bio) VALUES ('Walter', null, 'Isaacson', 'Journalist and historian Walter Isaacson is best known in literary circles as the writer of magisterial biographies, scholarly and meticulously researched, yet immensely entertaining.');
...
INSERT INTO bookstore353.authors (first_name, middle_name, last_name, bio) VALUES ('James', null, 'Patterson', 'James Patterson is a prolific author of thrillers, mysteries, young adult novels and more. His first successful series featured psychologist Alex Cross.');
...
INSERT INTO bookstore353.authors (first_name, middle_name, last_name, bio) VALUES ('Gillian', null, 'Flynn', 'GILLIAN FLYNN’s debut novel, Sharp Objects, was an Edgar Award finalist and the winner of two of Britain’s Dagger Awards. She lives in Chicago with her husband, Brett Nolan, and a rather giant cat named Roy.');
...
INSERT INTO bookstore353.branches (publisher_id, branch_name, branch_manager, phone_number, email, address) VALUES (1, 'Grand Central Publishing', 'Sherrilyn Kenyon', '+1 212-364-1100', null, '1390 6th Ave, New York, NY 10104, USA');
INSERT INTO bookstore353.branches (publisher_id, branch_name, branch_manager, phone_number, email, address) VALUES (1, 'Little, Brown and Company', 'Pete Hamill', '+1 617-227-0730', null, '53 State St, Boston, MA 02109, USA');
