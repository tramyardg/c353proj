...
-- (1, 1, '2018-07-07', 'PROCESSING'),
-- (2, 7, '2018-04-21', 'PROCESSING'),
-- (3, 9, '2018-11-05', 'PROCESSING'),
-- (4, 3, '2018-12-25', 'PROCESSING'),
-- (5, 1, '2018-09-04', 'PROCESSING'),
-- (6, 1, '2019-01-19', 'PROCESSING'),
-- (7, 3, '2018-12-05', 'PROCESSING'),
-- (8, 5, '2019-01-20', 'PROCESSING'),
-- (9, 1, '2019-01-17', 'PROCESSING'),
-- (10, 10, '2018-07-29', 'PROCESSING');
-- SET FOREIGN_KEY_CHECKS = 1;
-- 
-- SET FOREIGN_KEY_CHECKS = 0;
